...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c-1.421-.62-2.8-1.34-4.09-2.182a.75.75 0 0 1 .44-1.382c3.11.956 6.443 1.48 9.842 1.48a12.054 12.054 0 0 0 9.842-1.48.75.75 0 0 1 .44 1.382c-1.29.842-2.669 1.562-4.09 2.182Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a3.75 3.75 0 0 0 .495-7.467 5.99 5.99 0 0 0-1.925 3.546 5.97 5.97 0 0 0-1.623 3.546A3.75 3.75 0 0 0 12 18Z" />
    </svg>
);
...
export const ToolsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l.354-.354a3.75 3.75 0 0 0-5.303-5.303l-.354.354M3 21l3.75-3.75m.75-7.5 3.75 3.75" />
    </svg>
);
...
export const CrownIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 8.638 5.214M15.362 5.214A3.375 3.375 0 0 1 12 3c-1.18 0-2.23.58-2.862 1.486M15.362 5.214A3.375 3.375 0 0 0 12 7.5c-1.18 0-2.23-.58-2.862-1.486" />
    </svg>
);

export const BrushIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c-4.39 0-6.75 2.1-8.25 3.75S.75 10.35.75 12c0 1.65 1.13 3.15 2.625 3.75S6.27 15 9 15c2.25 0 4.13-1.02 5.625-2.25s2.625-3.375 2.625-5.25c0-1.65-1.13-3.15-2.625-3.75S14.27 3 12 3Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 15v5.25c0 .62.5 1.12 1.12 1.12h.01c.62 0 1.12-.5 1.12-1.12V15" />
    </svg>
);
...
export const PointIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
